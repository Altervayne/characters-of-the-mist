...
interface AddPortraitButtonProps {
   onClick: () => void;
}



export function AddPortraitButton({ onClick }: AddPortraitButtonProps) {
   ...
   return (
      ...
      >
         ...
         <span className="text-3xl font-semibold">{t('CharacterSheetPage.addPortrait')}</span>
      </div>
   );
}

...
export const PRESET_THEMES: Record<string, { light: TokenSet; dark: TokenSet; radius: string }> = {
   'theme-neutral': {
      ...
      dark: {
         ...
         destructive: 'hsl(0 63% 50%)', 'destructive-foreground': 'hsl(210 40% 98%)',
   ...
   'theme-legends': {
      ...
      light: {
         ...
         destructive: 'hsl(355 72% 51%)', 'destructive-foreground': 'hsl(0 0% 98%)',
      ...
      dark: {
         ...
         muted: 'hsl(43 31% 25%)', 'muted-foreground': 'hsl(43, 16%, 53%)',
   ...
   'theme-city-of-mist': {
      ...
      light: {
         ...
         muted: 'hsl(240 12% 68%)', 'muted-foreground': 'hsl(240 12% 35%)',
         accent: 'hsl(25 45% 72%)', 'accent-foreground': 'hsl(240 18% 10%)',
         destructive: 'hsl(0 84.2% 60.2%)', 'destructive-foreground': 'hsl(240 15% 96%)',
      ...
      dark: {
         ...
         muted: 'hsl(240 6% 22%)', 'muted-foreground': 'hsl(240 5% 60%)',
         accent: 'hsl(25 45% 48%)', 'accent-foreground': 'hsl(240 5% 95%)',
         destructive: 'hsl(0 63% 50%)', 'destructive-foreground': 'hsl(240 5% 96%)',
   ...
   'theme-otherscape': {
      ...
      light: {
         ...
         primary: 'hsl(200 75% 38%)', 'primary-foreground': 'hsl(210 15% 96%)',
         secondary: 'hsl(210 10% 68%)', 'secondary-foreground': 'hsl(210 18% 12%)',
         muted: 'hsl(210 10% 68%)', 'muted-foreground': 'hsl(210 12% 38%)',
      ...
      dark: {
         ...
         destructive: 'hsl(355 72% 51%)', 'destructive-foreground': 'hsl(0 0% 98%)',
         // Lifted with the missing hsl() wrapper restored (global.css had a bare "76 100% 70%").

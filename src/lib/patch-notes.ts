...
export const patchNotes: PatchNote[] = [
   {
      version: '2.0.0',
      content: `
### ✨ The Game Master Update!
This is a big one, and I hope it makes this app a lot more usable to a lot of people. To make this possible, I reviewed, and rewrote, almost all of the app's data systems. Now, Characters of the Mist is capable of storing a lot more information on its own.
What this means is that it is now possible to do a lot of cool things, like letting you store images !
